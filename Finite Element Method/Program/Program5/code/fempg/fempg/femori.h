...
{
	ofstream outfile;
	outfile.open("E:\\study_materials\\Finite Element Method\\Program5\\code\\cg.txt", ios::out);
	for (int i = 0; i < n; i++)
	{
...
{
	ofstream outfile;
	outfile.open("E:\\study_materials\\Finite Element Method\\Program5\\code\\mg.txt", ios::out);
	for (int i = 0; i < n; i++)
	{
		int N = pow(2, i) * 10;                             //区间离散程度；
		error[i][0] = N;
...
{
	ofstream outfile;
	outfile.open("E:\\study_materials\\Finite Element Method\\Program\\Program5\\code\\mg.txt", ios::out);
	for (int i = 0; i < n; i++)
	{
		int N = pow(2, i) * 10;                             //区间离散程度；
		error[i][0] = N;
